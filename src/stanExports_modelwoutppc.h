...
namespace model_modelwoutppc_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_modelwoutppc");
    reader.add_event(41, 39, "end", "model_modelwoutppc");
    return reader;
}
...
class model_modelwoutppc
  : public stan::model::model_base_crtp<model_modelwoutppc> {
private:
        int N;
        ...
        int is_log;
public:
    model_modelwoutppc(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_modelwoutppc_namespace::model_modelwoutppc";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_modelwoutppc_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_modelwoutppc_namespace::model_modelwoutppc stan_model;
#ifndef USING_R
