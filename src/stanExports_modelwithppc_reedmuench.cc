...
#include "stanExports_modelwithppc_reedmuench.h"

RCPP_MODULE(stan_fit4modelwithppc_reedmuench_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_modelwithppc_reedmuench")
